...
//       try {
//         if (typeof user.createOrder === 'function') {
//           await user.createOrder({ orderid: order.id, status: 'PENDING' })
//         } else {
//           throw new Error('createOrder is not a function on user')
//         }
...
//         : Promise.reject(new Error('user.update is not a function'))
